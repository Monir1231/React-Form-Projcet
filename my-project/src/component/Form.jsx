...
function From(){
    ...
    return (
        <>
         ...
         <div className=" w-full p-10 max-w-md bg-gray-50  rounded-lg shadow-2xl  hover:scale-105 transition-all duration-300">
            ...
            <div>
                ...
                <p className="text-gray-300 text-left py-2">Name:{SubmittedData.name}</p>
                <p className="text-gray-300 text-left">Email:{SubmittedData.email}</p>
            </div>
         </div>
